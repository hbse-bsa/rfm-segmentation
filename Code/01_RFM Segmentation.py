...
# MAGIC %pip install openpyxl==3.1.2 "mlflow[databricks]" "pydantic>=1.10,<2"
...
# MAGIC %sh 
# MAGIC
# MAGIC rm -rf /tmp/clv/online_retail  # drop any old copies of data
# MAGIC mkdir -p /tmp/clv/online_retail # ensure destination folder exists
# MAGIC
# MAGIC # download data to destination folder
# MAGIC wget -N http://archive.ics.uci.edu/ml/machine-learning-databases/00352/Online%20Retail.xlsx -P /tmp/clv/online_retail
...
xlsx_filename = "/tmp/clv/online_retail/Online Retail.xlsx"
...
tsne = TSNE(n_components=2, perplexity=80, max_iter=1000, init='pca', learning_rate='auto')
